 ...
 */
public class TradeWithoutEmeraldPotionsItemStack implements TradeOffers.Factory {
    ...
    public TradeWithoutEmeraldPotionsItemStack(ItemStack item, int $, Potion potionType, int maxUses, int experience) {
        this.firstBuy = item;
        this.price = $;
    ...
    public TradeOffer create(Entity entity, Random random) {
        ...
        return new TradeOffer(this.firstBuy, awkwardPotion, itemStack2, this.maxUses, this.experience, this.multiplier);
    }
}
