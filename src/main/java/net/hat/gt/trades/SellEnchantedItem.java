...
public class SellEnchantedItem implements UpgradedTradeOfferFactory {
    ...
    public UpgradedTradeOffer create(Entity entity, Random random) {
        ...
        return new UpgradedTradeOffer(new ItemStack(this.firstBuy.getItem(), this.price), itemStack2, itemStack, this.maxUses, this.experience, 0F, this.playerExperience);
    }
}
