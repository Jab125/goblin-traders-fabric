...
public class EatFavouriteFoodGoal extends HoldInHandsGoal<AbstractGoblinEntity>
{
    ...
    {
        super(entity, entity.getFavouriteFood().copy(), SoundEvents.ENTITY_PLAYER_BURP, entity1 -> entity1.getHealth() < entity1.getMaxHealth() && entity1.getRandom().nextInt(100) == 0);
