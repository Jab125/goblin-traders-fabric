...
public class UpgradedBasicTrade implements ITradeType<UpgradedGoblinTrade>
{
    ...
    public UpgradedBasicTrade(ItemStack offerStack, ItemStack paymentStack, ItemStack secondaryPaymentStack, float priceMultiplier, int maxTrades, int merchantExperience, int playerExperience, EnchantmentLevelEntry[] enchantments, Collection<StatusEffectInstance> mobEffects, boolean isRequired)
    {
    ...
    public UpgradedGoblinTrade createTradeOffer()
    {
        ...
        return new UpgradedGoblinTrade(offerStack, this.paymentStack.copy(), this.secondaryPaymentStack.copy(), this.maxTrades, this.merchantExperience, this.playerExperience, this.priceMultiplier);
    }
    ...
    public static class Serializer extends TradeSerializer<UpgradedBasicTrade>
    {
        Serializer()
        {
            super(new Identifier(GobT.MODID, "upgraded_basic"));
        }

        @Override
        public UpgradedBasicTrade deserialize(JsonObject object)
        {
        ...
        @Override
        public JsonObject serialize(UpgradedBasicTrade trade)
        {
    ...
    public static class Builder
    {
        ...
        {
            return new UpgradedBasicTrade(this.offerStack, this.paymentStack, this.secondaryPaymentStack, this.priceMultiplier, this.maxTrades, this.merchantExperience, this.playerExperience, this.enchantments.toArray(new EnchantmentLevelEntry[0]), this.modEffects, required);
        }
