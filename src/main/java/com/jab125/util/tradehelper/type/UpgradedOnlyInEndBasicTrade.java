 ...
 * Remapped by Jab125
 */
public class UpgradedOnlyInEndBasicTrade implements ITradeType<UpgradedGoblinTradeIfInNotEnd>
{
    ...
    public UpgradedGoblinTradeIfInNotEnd createTradeOffer()
    {
        ...
        return new UpgradedGoblinTradeIfInNotEnd(offerStack, this.paymentStack.copy(), this.secondaryPaymentStack.copy(), this.maxTrades, this.merchantExperience, this.playerExperience, this.priceMultiplier);
    }
    ...
    public static class Serializer extends TradeSerializer<UpgradedOnlyInEndBasicTrade>
    {
        Serializer()
        {
            super(new Identifier(GobT.MODID, "upgraded_only_in_end_basic"));
        }
